...
# Inicializar
pygame.init()
pygame.mixer.music.load("TERROR.mp3")
...
# Carga imágenes
fondo = pygame.image.load("dd.jpg").convert()
nave_arr = pygame.image.load("arribaa.png").convert_alpha()
nave_abj = pygame.image.load("abajoo.png").convert_alpha()
nave_izq = pygame.image.load("izquierdaa.png").convert_alpha()
nave_der = pygame.image.load("derechaaa.png").convert_alpha()

aste_1a = pygame.image.load("caca.png").convert_alpha()
aste_1b = pygame.image.load("cac.png").convert_alpha()
aste_1c = pygame.image.load("ca.png").convert_alpha()
aste_1d = pygame.image.load("caca.png").convert_alpha()
...
aste_2a = pygame.image.load("cac.png").convert_alpha()
aste_2b = pygame.image.load("ca.png").convert_alpha()
aste_2c = pygame.image.load("caca.png").convert_alpha()
aste_2d = pygame.image.load("cac.png").convert_alpha()
...
while en_juego:
    ...
    while en_inicio:
        ...
        historia = [
            ...
            "                 Dj khaleb se desato por que no jugo roblox.",
            "               Dj khaleb esta enojado y te esta tirando caca ",
            "              tienes que darle su telefono si no te comera vivo",
            "              esta mision es solo para los mas valientes",
            "        intenta devolverle el telefono para que juegue roblox.",
            "                         solo asi no te matara.",
            "",
    ...
    while en_partida:
        ...
        while en_final:
            ...
            historia_perdido = [
                "    dj khaleb se ha descontrolado y ha causado una masacre",
                "   sin embargo te escondiste rapidamente y llegaron los",
                "   policias y jose torres para ponterte a salvo. ",
                "  ¿quieres volver a darle su telefono para que se calmen las aguas?",
                "",
                "              Pulsa 's' para volverlo a intentar",
                "              Pulsa 'n' para salir del juego"]

            historia_ganado = [
                "  le diste exitosamente su telefono con roblox para que se",
                "  tranquilice, dj khaleb va hacia ti y te da un abrazo,",
                "     lo reconfortas pero mientras de abraza te apuñala y te ",
                "                     MI LIFE IS ROBLOX",
                "",
